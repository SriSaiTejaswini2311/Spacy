    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Only brand owners can create spaces.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-black text-white py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-gray-800 rounded-xl p-6 mb-8">
          <h1 className="text-3xl font-bold mb-2" style={{color: '#8C52FF'}}>Create New Space</h1>
          <p className="text-gray-400">Add a new space to your portfolio</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl p-6">
          ...
          <div className="mt-8 flex justify-end space-x-4">
            ...
            <button
              ...
              style={{backgroundColor: loading ? '#6B7280' : '#8C52FF'}}
            >
